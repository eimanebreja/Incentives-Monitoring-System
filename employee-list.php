  ...
  <li><a href="logout.php">Logout</a></li>
    ...
    <div id="modalpassword" class="modal modal-fixed-footer" style="height: 40% !important;">
        ...
        <ul style="width:300px; margin-top:65px;" class="side-nav fixed">
            ...
            <li><a href="employee-list.php" class="active"><i class="fa fa-list-ul" aria-hidden="true"></i>List of Employee</a></li>
...
while ($employee_row = mysqli_fetch_array($result_employee)) {$id = $employee_row['emp_id'];?>
                        ...
                        <tr class="del<?php echo $id ?>">
                            <td><?php echo "$i."; ?></td>
                            <td><img src="<?php echo $employee_row['emp_image']; ?>" width="60" height="60" class="img-circle"></td>
                            <td><span style="width:20px; height:20px; border-radius: 50%;font-size:8px;background-color:<?php echo $employee_row['emp_color']; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> <?php echo $employee_row['emp_name']; ?></td>
                            <td><?php echo $employee_row['emp_position']; ?></td>
                            <td><?php echo $employee_row['emp_email']; ?></td>
                            <td><?php echo $employee_row['emp_phone']; ?></td>
                            <td>
                            <a rel="tooltip" style="color:red"  title="Delete" class="modal-trigger delete" id="<?php echo $id; ?>" href="#delete_employee<?php echo $id; ?>"> <i class="fa fa-trash-o fa-2x"  aria-hidden="true"></i> </a> &nbsp;&nbsp;
                             <?php include 'modal-delete-employee.php';?>
                             <a rel="tooltip" style="color:black"  title="Edit" class="modal-trigger edit" id="e<?php echo $id; ?>" href="#edit_employees<?php echo $id; ?>" data-toggle="modal" class="btn btn-success"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></a>
                            <?php include 'modal-edit-employee.php';?>
                            </td>
                        </tr>
                        <?php $i++;}?>
                        </tbody>
